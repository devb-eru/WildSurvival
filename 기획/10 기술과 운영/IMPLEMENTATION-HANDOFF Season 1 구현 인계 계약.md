...
소모품은 Day 단위 한도를 Encounter·보스·5초 개인 교전 범위로 교체했다. 해독·냉각·지혈의 제한 중첩 제거, 신경 안정제 단일 제거와 HARD_CC 자기 사용 거부, 냉각 연고의 5초 BURN 지속시간 감소를 실행한다. 야전 배급팩은 비전투 8초·전투 12초 동안 실제 아이템 1개를 예약하고 좌클릭·접속 종료·서버 종료 취소 시 반환한다. AP 자극제 AP +30, 기본 구조 고정대 중단 임계 +15%, 정화 앰풀 개인 오염 -15는 `PRODUCTION-DATA-CLOSURE-001`로 잠겼으며 개인 오염·구조 예약 런타임은 아직 미구현이다.
