...
| 시설 | 실제 투입·시험 |
|---|---|
| R01 | 안정 프레임 6, 경화 골재 10, 부품 A 원장 결합 |
| R02 | 동력 행렬 3, 공진 코일 4, 부품 B 원장 결합, 60초 출력 시험 |
| R03 | 교정 렌즈 3, 패턴 잔재 4, 부품 C 원장 결합, 동·서·남·북 중 무작위 3방향과 정수 보정값을 GUI에서 추론 |
| R04 | 정화 행렬 3, 정화 촉매 6, 부품 D 원장 결합, 방문 원장에서 서로 다른 환경 2개를 GUI로 선택·검사 |
| R05 | 말뚝마다 고밀도 합금 1, 교정 렌즈 1, 공진 코일 1, R03 세 방향 구간에 총 3개 배치·교정 |
