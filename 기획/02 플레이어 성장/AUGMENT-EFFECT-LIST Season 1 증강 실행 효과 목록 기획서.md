...
| `AUG-S-005` | `GUARD_IMPACT_AND_FAILED_PARRY_TRANSITION_REDUCE` | `GUARD_RESOLVED`, `PARRY_RESOLVED` | `PLAYER_ACTION` |
...
| `AUG-P-011` | `GUARD_PROJECTILE_PARTY_AURA` | `GUARD_TICK`, `PROJECTILE_DAMAGE_QUERY`, `MOVEMENT_QUERY` | `PLAYER` |
