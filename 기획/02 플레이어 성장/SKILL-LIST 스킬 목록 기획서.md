...
| 구분 | 장착 수 | 변경 조건 |
|---|---:|---|
| 무기 일반 공격 | 1, 자동 | 현재 주무기 또는 권투 상태에 고정 |
| 무기 액티브 | 후보 4개 중 2개 | 비전투·비추적·비보스 안전 상태 |
| 비무기 공용 액티브 | 후보 중 1개 | 비전투 안전 상태 |
...
모든 무기군이 사용할 수 있으며 공용 액티브 슬롯 하나를 차지한다.
...
- 무기 액티브 4개 중 2개와 공용 액티브 1개 장착 제한
...
- 각 무기군에 실제 선택 가능한 액티브 4개와 기본 추천 2개가 있다.
